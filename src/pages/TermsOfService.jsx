...
const TermsOfService = () => {
    return (
        <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto relative z-10">
            ...
            >
                <h1 className="text-4xl md:text-6xl font-black font-unbounded mb-8 text-white">Terms of Service<span className="text-[#FFE600]">.</span></h1>
                ...
                <div className="space-y-12 text-lg leading-relaxed text-zinc-300">
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">1. Acceptance of Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">2. Services Description</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">3. Intellectual Property</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">4. User Conduct</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">5. Limitation of Liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">6. Revisions and Errata</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4 text-white">7. Contact Information</h2>
                        <p>
                            If you have any questions about these Terms of Service, please contact us at <a href="mailto:support@pixelog.in" className="text-[#FFE600] hover:underline">support@pixelog.in</a>.
                        </p>
                    </section>
                </div>
            </motion.div>
