...
const PrivacyPolicy = () => {
    return (
        <main className="pt-32 pb-20 px-6 max-w-4xl mx-auto relative z-10">
            ...
            >
                <h1 className="text-4xl md:text-6xl font-black font-unbounded mb-8">Privacy Policy<span className="text-[#ff4d00]">.</span></h1>
                ...
                <div className="space-y-12 text-lg leading-relaxed text-zinc-800">
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4">1. Information We Collect</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4">2. How We Use Your Information</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4">3. Data Protection</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4">4. Cookies</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4">5. Third-Party Links</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold font-unbounded mb-4">6. Contact Us</h2>
                        <p>
                            If there are any questions regarding this privacy policy, you may contact us using the information below:
                            <br /><br />
                            <a href="mailto:support@pixelog.in" className="text-[#ff4d00] hover:underline">support@pixelog.in</a>
                        </p>
                    </section>
                </div>
            </motion.div>
